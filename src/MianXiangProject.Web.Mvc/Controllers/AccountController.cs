...
using MianXiangProject.Sessions;
using MianXiangProject.Web.Models.Account;
using MianXiangProject.Web.Views.Shared.Components.TenantChange;

namespace MianXiangProject.Web.Controllers
{
    public class AccountController : MianXiangProjectControllerBase
    {
